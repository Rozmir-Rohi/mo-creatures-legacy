...
public class ModelWolfAltar extends ModelBase {
	...
	public ModelWolfAltar() {
		...
		Base.cubeList.add(new ModelBox(Base, 43, 103, -9.0F, 12.5F, -1.0F, 18, 2, 22, 0.0F));
		Base.cubeList.add(new ModelBox(Base, 28, 98, -11.0F, 14.0F, -3.0F, 22, 3, 26, 0.0F));
		Base.cubeList.add(new ModelBox(Base, 28, 98, -11.0F, 10.5F, -3.0F, 22, 2, 26, 0.0F));

		Head = new ModelRenderer(this);
		Head.setRotationPoint(0.0F, 7.0F, -10.0F);
		Head.cubeList.add(new ModelBox(Head, 0, 0, -4.0F, -16.0F, -1.0F, 8, 8, 6, 0.0F));

		MouthB = new ModelRenderer(this);
		MouthB.setRotationPoint(0.0F, 7.0F, -10.0F);
		MouthB.cubeList.add(new ModelBox(MouthB, 16, 33, -2.0F, -10.0F, -2.0F, 4, 1, 2, 0.0F));

		Nose2 = new ModelRenderer(this);
		Nose2.setRotationPoint(0.0F, 7.0F, -10.0F);
		Nose2.cubeList.add(new ModelBox(Nose2, 0, 25, -2.0F, -11.0F, -7.0F, 4, 2, 6, 0.0F));
		...
		TailD_r1.cubeList.add(new ModelBox(TailD_r1, 52, 69, -10.0F, 4.3F, 5.9F, 3, 5, 3, 0.0F));
		...
		TailC_r1.cubeList.add(new ModelBox(TailC_r1, 48, 59, -12.0F, -0.7F, 4.15F, 4, 6, 4, 0.0F));
		...
		TailB_r1.cubeList.add(new ModelBox(TailB_r1, 48, 49, -8.0F, -11.25F, 8.0F, 4, 6, 4, 0.0F));
		...
		Leg3B_r1.cubeList.add(new ModelBox(Leg3B_r1, 0, 76, -5.1619F, 6.3817F, 4.863F, 2, 2, 5, 0.0F));
		Leg3B_r1.cubeList.add(new ModelBox(Leg3B_r1, 0, 76, 2.5883F, 6.3787F, 4.8717F, 2, 2, 5, 0.0F));
		...
		Leg3A.cubeList.add(new ModelBox(Leg3A, 0, 64, -8.25F, -3.4197F, -2.9333F, 2, 7, 5, 0.0F));
		Leg3A.cubeList.add(new ModelBox(Leg3A, 0, 64, -0.5F, -3.4197F, -2.9333F, 2, 7, 5, 0.0F));
		...
		Leg1A_r1.cubeList.add(new ModelBox(Leg1A_r1, 28, 57, 4.0F, -18.6474F, -13.2936F, 2, 8, 4, 0.0F));
		Leg1A_r1.cubeList.add(new ModelBox(Leg1A_r1, 28, 57, 14.0F, -18.6474F, -13.2936F, 2, 8, 4, 0.0F));

		Leg1B = new ModelRenderer(this);
		Leg1B.setRotationPoint(4.0F, 9.5F, -5.5F);
		setRotationAngle(Leg1B, -0.3054F, 0.0F, 0.0F);
		Leg1B.cubeList.add(new ModelBox(Leg1B, 28, 69, 0.0F, -1.7103F, -0.3106F, 2, 8, 2, 0.0F));
		Leg1B.cubeList.add(new ModelBox(Leg1B, 28, 69, -10.0F, -1.7103F, -0.3106F, 2, 8, 2, 0.0F));

		Leg1C = new ModelRenderer(this);
		Leg1C.setRotationPoint(4.0F, 9.5F, -5.5F);
		Leg1C.cubeList.add(new ModelBox(Leg1C, 28, 79, -0.5067F, 6.0F, -2.5F, 3, 2, 3, 0.0F));
		Leg1C.cubeList.add(new ModelBox(Leg1C, 28, 79, -1.5067F, 6.0F, 4.0F, 3, 2, 3, 0.0F));
		Leg1C.cubeList.add(new ModelBox(Leg1C, 28, 79, -9.2567F, 6.0F, 4.0F, 3, 2, 3, 0.0F));
		Leg1C.cubeList.add(new ModelBox(Leg1C, 28, 79, -10.5067F, 6.0F, -2.5F, 3, 2, 3, 0.0F));
	}
