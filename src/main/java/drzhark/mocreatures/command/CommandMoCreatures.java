...
public class CommandMoCreatures extends CommandBase {
    ...
    static {
        ...
        commands.add("/moc specialHorsesFightBack <boolean>");
        commands.add("/moc enableMoCPetDeathMessages <boolean>");
        ...
        commands.add("/moc enablestrictownership <boolean>");
        ...
        tabCompletionStrings.add("specialHorsesFightBack");
        tabCompletionStrings.add("enableMoCPetDeathMessages");
        ...
        tabCompletionStrings.add("enablestrictownership");
