...
import drzhark.mocreatures.client.renderer.entity.MoCRenderWerewolfMinecraftComesAliveVillagerWitchery;
...
public class MoCClientProxy extends MoCProxy {
    ...
    public void registerRenderInformation()
    {
        ...
        RenderingRegistry.registerEntityRenderingHandler(MoCEntityWerewolf.class, new MoCRenderWerewolf(new MoCModelWerewolfHuman(), new MoCModelWerewolf(), 0.7F));
        RenderingRegistry.registerEntityRenderingHandler(MoCEntityWerewolfWitchery.class, new MoCRenderWerewolfWitchery(new MoCModelWerewolfHuman(), new MoCModelWerewolf(), 0.7F));
        RenderingRegistry.registerEntityRenderingHandler(MoCEntityWerewolfMinecraftComesAliveVillagerWitchery.class, new MoCRenderWerewolfMinecraftComesAliveVillagerWitchery(new MoCModelWerewolfHuman(), 0.7F));
