...
public class MoCModelWere extends ModelBase {
    ...
    public MoCModelWere()
    {
        ...
        setRotation(Chest, 0.641331F, 0F, 0F);
        ...
        RHand.addBox(-6F, 12.5F, -1.5F, 4, 3, 4);
        RHand.setRotationPoint(-4F, -4F, -2F);
        ...
        LHand.addBox(2F, 12.5F, -1.5F, 4, 3, 4);
        LHand.setRotationPoint(4F, -4F, -2F);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        Head.rotateAngleY = f3 / radianF; //this moves head to left and right
        //Head.rotateAngleX = f4 / radianF; //this moves head up and down

        if (!hunched)
        {
            Head.rotationPointY = -8F;
            Head.rotationPointZ = -6F;
            ...
            Chest.rotationPointY = -6F;
            Chest.rotationPointZ = -2.5F;
            Chest.rotateAngleX = 36 / radianF;
        ...
        else
        {
            ...
            Head.rotationPointZ = -11F;
            Head.rotateAngleX = (15F + f4) / radianF;
            ...
            Chest.rotationPointY = 1F;
            Chest.rotationPointZ = -7.5F;
            Chest.rotateAngleX = 60 / radianF;
