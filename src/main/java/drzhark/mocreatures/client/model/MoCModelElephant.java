...
public class MoCModelElephant extends ModelBase {
    ...
    {
        float yOffset = f;
        Head.rotationPointY = yOffset + -10F;
        Neck.rotationPointY = yOffset + -8F;
        HeadBump.rotationPointY = yOffset + -10F;
        Chin.rotationPointY = yOffset + -10F;
        LowerLip.rotationPointY = yOffset + -10F;
        Back.rotationPointY = yOffset + -4F;
        LeftSmallEar.rotationPointY = yOffset + -10F;
        LeftBigEar.rotationPointY = yOffset + -10F;
        RightSmallEar.rotationPointY = yOffset + -10F;
        RightBigEar.rotationPointY = yOffset + -10F;
        Hump.rotationPointY = yOffset + -13F;
        Body.rotationPointY = yOffset + -2F;
        Skirt.rotationPointY = yOffset + 8F;
        RightTuskA.rotationPointY = yOffset + -10F;
        RightTuskB.rotationPointY = yOffset + -10F;
        RightTuskC.rotationPointY = yOffset + -10F;
        RightTuskD.rotationPointY = yOffset + -10F;
        LeftTuskA.rotationPointY = yOffset + -10F;
        LeftTuskB.rotationPointY = yOffset + -10F;
        LeftTuskC.rotationPointY = yOffset + -10F;
        LeftTuskD.rotationPointY = yOffset + -10F;
        TrunkA.rotationPointY = yOffset + -3F;
        TrunkB.rotationPointY = yOffset + 5.5F;
        TrunkC.rotationPointY = yOffset + 13F;
        TrunkD.rotationPointY = yOffset + 16F;
        TrunkE.rotationPointY = yOffset + 19.5F;
        FrontRightUpperLeg.rotationPointY = yOffset +  4F;
        FrontRightLowerLeg.rotationPointY = yOffset + 14F;
        FrontLeftUpperLeg.rotationPointY = yOffset +4F;
        FrontLeftLowerLeg.rotationPointY = yOffset + 14F;
        BackRightUpperLeg.rotationPointY = yOffset + 4F;
        BackRightLowerLeg.rotationPointY = yOffset + 14F;
        BackLeftUpperLeg.rotationPointY = yOffset + 4F;
        BackLeftLowerLeg.rotationPointY = yOffset + 14F;
        TailRoot.rotationPointY = yOffset + -8F;
        Tail.rotationPointY = yOffset + -8F;
        TailPlush.rotationPointY = yOffset + -8F;
        StorageRightBedroll.rotationPointY = yOffset + -10.2F;
        StorageLeftBedroll.rotationPointY = yOffset + -10.2F;
        StorageFrontRightChest.rotationPointY = yOffset + -1.2F;
        StorageBackRightChest.rotationPointY = yOffset + -1.2F;
        StorageFrontLeftChest.rotationPointY = yOffset + -1.2F;
        StorageBackLeftChest.rotationPointY = yOffset + -1.2F;
        StorageRightBlankets.rotationPointY = yOffset + -10.2F;
        StorageLeftBlankets.rotationPointY = yOffset + -10.2F;
        HarnessBlanket.rotationPointY = yOffset + -13.2F;
        HarnessUpperBelt.rotationPointY = yOffset + -2F;
        HarnessLowerBelt.rotationPointY = yOffset + -2F;
        CabinPillow.rotationPointY = yOffset + -16F;
        CabinLeftRail.rotationPointY = yOffset + -23F;
        Cabin.rotationPointY = yOffset + -35F;
        CabinRightRail.rotationPointY = yOffset + -23F;
        CabinBackRail.rotationPointY = yOffset + -23F;
        CabinRoof.rotationPointY = yOffset + -34F;
        FortBackRightWall.rotationPointY = yOffset + -16F;
        FortBackLeftWall.rotationPointY = yOffset + -16F;
        FortBackWall.rotationPointY = yOffset + -16F;
        FortNeckBeam.rotationPointY = yOffset + -16F;
        FortBackBeam.rotationPointY = yOffset + -16F;
        FortFloor1.rotationPointY = yOffset + -16F;
        FortFloor2.rotationPointY = yOffset + -16F;
        FortFloor3.rotationPointY = yOffset + -16F;
        
        StorageUpLeft.rotationPointY = yOffset + -16F;
        StorageUpRight.rotationPointY = yOffset + -16F;
        
        TuskLD1.rotationPointY = yOffset + -10F;
        TuskLD2.rotationPointY = yOffset + -10F;
        TuskLD3.rotationPointY = yOffset + -10F;
        TuskLD4.rotationPointY = yOffset + -10F;
        TuskLD5.rotationPointY = yOffset + -10F;
        TuskRD1.rotationPointY = yOffset + -10F;
        TuskRD2.rotationPointY = yOffset + -10F;
        TuskRD3.rotationPointY = yOffset + -10F;
        TuskRD4.rotationPointY = yOffset + -10F;
        TuskRD5.rotationPointY = yOffset + -10F;
        TuskLI1.rotationPointY = yOffset + -10F;
        TuskLI2.rotationPointY = yOffset + -10F;
        TuskLI3.rotationPointY = yOffset + -10F;
        TuskLI4.rotationPointY = yOffset + -10F;
        TuskLI5.rotationPointY = yOffset + -10F;
        TuskRI1.rotationPointY = yOffset + -10F;
        TuskRI2.rotationPointY = yOffset + -10F;
        TuskRI3.rotationPointY = yOffset + -10F;
        TuskRI4.rotationPointY = yOffset + -10F;
        TuskRI5.rotationPointY = yOffset + -10F;
        TuskLW1.rotationPointY = yOffset + -10F;
        TuskLW2.rotationPointY = yOffset + -10F;
        TuskLW3.rotationPointY = yOffset + -10F;
        TuskLW4.rotationPointY = yOffset + -10F;
        TuskLW5.rotationPointY = yOffset + -10F;
        TuskRW1.rotationPointY = yOffset + -10F;
        TuskRW2.rotationPointY = yOffset + -10F;
        TuskRW3.rotationPointY = yOffset + -10F;
        TuskRW4.rotationPointY = yOffset + -10F;
        TuskRW5.rotationPointY = yOffset + -10F;
