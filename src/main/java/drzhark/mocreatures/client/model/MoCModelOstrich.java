...
public class MoCModelOstrich extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        boolean isRamming = (entityostrich.getType() == 8 && (entityostrich.sprintCounter > 0 && entityostrich.sprintCounter < 150) && (entityostrich.riddenByEntity != null));
        ...
        setRotationAngles(f, f1, f2, f3, f4, f5, isHiding, isRamming, wingFlap, rider, jumpCounter, floating);
