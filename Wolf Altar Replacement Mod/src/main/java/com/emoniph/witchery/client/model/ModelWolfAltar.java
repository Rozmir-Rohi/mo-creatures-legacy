...
public class ModelWolfAltar extends ModelBase {
	...
	public ModelWolfAltar() {
		...
		Base.cubeList.add(new ModelBox(Base, 45, 105, -8.0F, 10.0F, 0.0F, 16, 3, 20, 0.0F));
		Base.cubeList.add(new ModelBox(Base, 28, 98, -11.0F, 13.0F, -3.0F, 22, 4, 26, 0.0F));

		Head = new ModelRenderer(this);
		Head.setRotationPoint(0.0F, 7.0F, -10.0F);
		Head.cubeList.add(new ModelBox(Head, 0, 0, -4.0F, -15.0F, -2.0F, 8, 8, 6, 0.0F));

		MouthB = new ModelRenderer(this);
		MouthB.setRotationPoint(0.0F, 7.0F, -10.0F);
		MouthB.cubeList.add(new ModelBox(MouthB, 16, 33, -2.0F, -8.0F, -3.0F, 4, 1, 2, 0.0F));

		Nose2 = new ModelRenderer(this);
		Nose2.setRotationPoint(0.0F, 7.0F, -10.0F);
		Nose2.cubeList.add(new ModelBox(Nose2, 0, 25, -2.0F, -10.0F, -8.0F, 4, 2, 6, 0.0F));

		Neck = new ModelRenderer(this);
		Neck.setRotationPoint(0.0F, 10.0F, -6.0F);
		setRotationAngle(Neck, -0.4538F, 0.0F, 0.0F);
		Neck.cubeList.add(new ModelBox(Neck, 28, 0, -3.5F, -15.539F, -8.6653F, 7, 8, 7, 0.0F));

		Neck2 = new ModelRenderer(this);
		Neck2.setRotationPoint(0.0F, 14.0F, -10.0F);
		setRotationAngle(Neck2, -0.4538F, 0.0F, 0.0F);
		Neck2.cubeList.add(new ModelBox(Neck2, 0, 14, -1.5F, -14.539F, -6.6653F, 3, 4, 7, 0.0F));

		LSide = new ModelRenderer(this);
		LSide.setRotationPoint(0.0F, 7.0F, -10.0F);
		setRotationAngle(LSide, -0.2094F, 0.4189F, -0.0873F);
		LSide.cubeList.add(new ModelBox(LSide, 28, 33, 2.3285F, -13.0413F, -0.495F, 2, 6, 6, 0.0F));

		RSide = new ModelRenderer(this);
		RSide.setRotationPoint(0.0F, 7.0F, -10.0F);
		setRotationAngle(RSide, -0.2094F, -0.4189F, 0.0873F);
		RSide.cubeList.add(new ModelBox(RSide, 28, 45, -4.3285F, -13.0413F, -0.495F, 2, 6, 6, 0.0F));

		Nose = new ModelRenderer(this);
		Nose.setRotationPoint(0.0F, 7.0F, -10.0F);
		setRotationAngle(Nose, 0.2793F, 0.0F, 0.0F);
		Nose.cubeList.add(new ModelBox(Nose, 44, 33, -1.5F, -12.2326F, -5.2473F, 3, 2, 7, 0.0F));

		Mouth = new ModelRenderer(this);
		Mouth.setRotationPoint(0.0F, 7.0F, -10.0F);
		Mouth.cubeList.add(new ModelBox(Mouth, 1, 34, -2.0F, -8.0F, -7.5F, 4, 1, 5, 0.0F));

		MouthOpen = new ModelRenderer(this);
		MouthOpen.setRotationPoint(0.0F, 7.0F, -10.0F);
		setRotationAngle(MouthOpen, 0.6109F, 0.0F, 0.0F);
		MouthOpen.cubeList.add(new ModelBox(MouthOpen, 1, 34, -2.0F, -7.5355F, -2.3405F, 4, 1, 5, 0.0F));

		REar = new ModelRenderer(this);
		REar.setRotationPoint(0.0F, 7.0F, -10.0F);
		setRotationAngle(REar, 0.0F, 0.0F, -0.1745F);
		REar.cubeList.add(new ModelBox(REar, 22, 0, -1.027F, -19.6962F, 1.5F, 3, 5, 1, 0.0F));

		LEar = new ModelRenderer(this);
		LEar.setRotationPoint(0.0F, 7.0F, -10.0F);
		setRotationAngle(LEar, 0.0F, 0.0F, 0.1745F);
		LEar.cubeList.add(new ModelBox(LEar, 13, 14, -1.973F, -19.6962F, 1.5F, 3, 5, 1, 0.0F));

		Body = new ModelRenderer(this);
		Body.setRotationPoint(0.0F, 6.5F, 2.0F);
		setRotationAngle(Body, 1.5708F, 0.0F, 0.0F);
		Body.cubeList.add(new ModelBox(Body, 20, 15, -4.0F, -8.5F, 0.0F, 8, 8, 10, 0.0F));

		Body_r1 = new ModelRenderer(this);
		Body_r1.setRotationPoint(0.0F, 17.5F, -2.0F);
		Body.addChild(Body_r1);
		setRotationAngle(Body_r1, -0.6895F, 0.0F, 0.0053F);
		Body_r1.cubeList.add(new ModelBox(Body_r1, 0, 40, -3.4407F, -22.0465F, -12.21F, 6, 16, 8, 0.0F));
		...
		TailD_r1.setRotationPoint(0.0F, -12.0F, 4.0F);
		...
		TailB_r1.setRotationPoint(0.0F, -9.5819F, -1.7359F);
		...
		Leg3B_r1.cubeList.add(new ModelBox(Leg3B_r1, 0, 76, -5.1502F, 11.9987F, 4.7822F, 2, 2, 5, 0.0F));
		Leg3B_r1.cubeList.add(new ModelBox(Leg3B_r1, 0, 76, 2.6F, 11.9957F, 4.7909F, 2, 2, 5, 0.0F));
		...
		Leg3A.cubeList.add(new ModelBox(Leg3A, 0, 64, -8.25F, -4.1364F, -1.0661F, 2, 7, 5, 0.0F));
		Leg3A.cubeList.add(new ModelBox(Leg3A, 0, 64, -0.5F, -4.1364F, -1.0661F, 2, 7, 5, 0.0F));
		...
		Leg1B.cubeList.add(new ModelBox(Leg1B, 28, 69, 0.0F, -1.7971F, 0.1818F, 2, 8, 2, 0.0F));
		Leg1B.cubeList.add(new ModelBox(Leg1B, 28, 69, -10.0F, -1.7971F, 0.1818F, 2, 8, 2, 0.0F));

		Leg1C = new ModelRenderer(this);
		Leg1C.setRotationPoint(4.0F, 9.5F, -5.5F);
		Leg1C.cubeList.add(new ModelBox(Leg1C, 28, 79, -0.5067F, 6.0F, -2.0F, 3, 2, 3, 0.0F));
		Leg1C.cubeList.add(new ModelBox(Leg1C, 28, 79, -1.5067F, 6.0F, 9.0F, 3, 2, 3, 0.0F));
		Leg1C.cubeList.add(new ModelBox(Leg1C, 28, 79, -9.2567F, 6.0F, 9.0F, 3, 2, 3, 0.0F));
		Leg1C.cubeList.add(new ModelBox(Leg1C, 28, 79, -10.5067F, 6.0F, -2.0F, 3, 2, 3, 0.0F));
	}
